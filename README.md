...
Технический анализ использует SMA20/SMA50, EMA12/EMA26, RSI14, MACD, Bollinger Bands, momentum, volatility, volume ratio, support/resistance, стакан, деривативы и Fear & Greed. Отдельный scalp-слой на 5m свечах следует идеям Murphy (тренд старшего ТФ, объём, уровни) и Solabuto (импульс, быстрый TP/SL).
